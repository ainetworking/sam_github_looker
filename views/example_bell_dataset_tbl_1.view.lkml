# The name of this view in Looker is "Example Bell Dataset Tbl 1"
view: example_bell_dataset_tbl_1 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `example_bell_dataset_1.example_bell_dataset_tbl_1`
    ;;
